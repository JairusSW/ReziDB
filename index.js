...
class ReziDB {
    ...
    */
    ...
    /**
    * Set A Key/Value As A Buffer Inside Of The Database Via A Stream
    * ```js 
    * await db.setStreamBuffer(key, stream, path)
    * ```
    * @license Apache-2.0
    * @returns undefined
    * @author JairusSW
    */
    ...
    async setStreamBuffer(key, stream, path) {

        try {
        
            let value = await getStream.buffer(stream)
    ...
    */
    ...
    async toArray() {
        ...
        try {
            ...
            this.database.createReadStream({ keys: false, values: true })
